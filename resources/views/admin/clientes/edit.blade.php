...
@section('content')
    <h1 class="page-title">MODIFICAR CLIENTE</h1>
    <p class="page-subtitle">Actualiza los datos del cliente</p>

    <div class="form-card">
        <form method="POST" action="{{ route('admin.clientes.update', $user) }}">
            @csrf
            @method('PUT')
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input id="name" type="text" name="name" value="{{ old('name', $user->name) }}" class="form-control" placeholder="Nombre">
                ...
                <div class="form-group">
                    ...
                    <input id="apellidos" type="text" name="apellidos" value="{{ old('apellidos', $user->apellidos) }}" class="form-control" placeholder="Apellidos">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input id="email" type="email" name="email" value="{{ old('email', $user->email) }}" class="form-control" placeholder="correo@ejemplo.com">
                ...
                <div class="form-group">
                    ...
                    <input id="telefono" type="text" name="telefono" value="{{ old('telefono', $user->telefono) }}" class="form-control" placeholder="Ej: 612345678">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input id="fecha_nacimiento" type="date" name="fecha_nacimiento" value="{{ old('fecha_nacimiento', $user->fecha_nacimiento ? $user->fecha_nacimiento->format('Y-m-d') : '') }}" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <select id="distancia" name="distancia" class="form-control">
                        ...
                        <option value="<5kms" {{ old('distancia', $user->distancia) == '<5kms' ? 'selected' : '' }}>Menos de 5 km</option>
                        <option value="<30kms" {{ old('distancia', $user->distancia) == '<30kms' ? 'selected' : '' }}>Menos de 30 km</option>
                        <option value="<100kms" {{ old('distancia', $user->distancia) == '<100kms' ? 'selected' : '' }}>Menos de 100 km</option>
                        <option value="<200kms" {{ old('distancia', $user->distancia) == '<200kms' ? 'selected' : '' }}>Menos de 200 km</option>
                    </select>
            ...
            <div class="form-row-3">
                <div class="form-group">
                    ...
                    <input id="envio_tipo_via" type="text" name="envio_tipo_via" value="{{ old('envio_tipo_via', $user->envio_tipo_via) }}" class="form-control" placeholder="Ej: Calle, Avda.">
                </div>

                <div class="form-group">
                    <label for="envio_nombre_via">Nombre de la vía</label>
                    <input id="envio_nombre_via" type="text" name="envio_nombre_via" value="{{ old('envio_nombre_via', $user->envio_nombre_via) }}" class="form-control" placeholder="Nombre de la calle">
                </div>

                <div class="form-group">
                    <label for="envio_numero">Número</label>
                    <input id="envio_numero" type="text" name="envio_numero" value="{{ old('envio_numero', $user->envio_numero) }}" class="form-control" placeholder="Nº">
                </div>
            </div>
            ...
            <div class="form-row-3">
                <div class="form-group">
                    ...
                    <input id="envio_piso_puerta" type="text" name="envio_piso_puerta" value="{{ old('envio_piso_puerta', $user->envio_piso_puerta) }}" class="form-control" placeholder="Ej: 3º 2ª">
                </div>

                <div class="form-group">
                    <label for="envio_codigo_postal">Código postal</label>
                    <input id="envio_codigo_postal" type="text" name="envio_codigo_postal" value="{{ old('envio_codigo_postal', $user->envio_codigo_postal) }}" class="form-control" placeholder="12345">
                </div>

                <div class="form-group">
                    <label for="envio_provincia">Provincia</label>
                    <input id="envio_provincia" type="text" name="envio_provincia" value="{{ old('envio_provincia', $user->envio_provincia) }}" class="form-control" placeholder="Provincia">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input id="envio_municipio" type="text" name="envio_municipio" value="{{ old('envio_municipio', $user->envio_municipio) }}" class="form-control" placeholder="Municipio o ciudad">
                </div>

                <div class="form-group">
                    <label for="envio_info_adicional">Información adicional</label>
                    <input id="envio_info_adicional" type="text" name="envio_info_adicional" value="{{ old('envio_info_adicional', $user->envio_info_adicional) }}" class="form-control" placeholder="Indicaciones extra">
                </div>
            </div>
            ...
            <div class="form-row-3">
                <div class="form-group">
                    ...
                    <input id="facturacion_tipo_via" type="text" name="facturacion_tipo_via" value="{{ old('facturacion_tipo_via', $user->facturacion_tipo_via) }}" class="form-control" placeholder="Ej: Calle, Avda.">
                </div>

                <div class="form-group">
                    <label for="facturacion_nombre_via">Nombre de la vía</label>
                    <input id="facturacion_nombre_via" type="text" name="facturacion_nombre_via" value="{{ old('facturacion_nombre_via', $user->facturacion_nombre_via) }}" class="form-control" placeholder="Nombre de la calle">
                </div>

                <div class="form-group">
                    <label for="facturacion_numero">Número</label>
                    <input id="facturacion_numero" type="text" name="facturacion_numero" value="{{ old('facturacion_numero', $user->facturacion_numero) }}" class="form-control" placeholder="Nº">
                </div>
            </div>
            ...
            <div class="form-row-3">
                <div class="form-group">
                    ...
                    <input id="facturacion_piso_puerta" type="text" name="facturacion_piso_puerta" value="{{ old('facturacion_piso_puerta', $user->facturacion_piso_puerta) }}" class="form-control" placeholder="Ej: 3º 2ª">
                </div>

                <div class="form-group">
                    <label for="facturacion_codigo_postal">Código postal</label>
                    <input id="facturacion_codigo_postal" type="text" name="facturacion_codigo_postal" value="{{ old('facturacion_codigo_postal', $user->facturacion_codigo_postal) }}" class="form-control" placeholder="12345">
                </div>

                <div class="form-group">
                    <label for="facturacion_provincia">Provincia</label>
                    <input id="facturacion_provincia" type="text" name="facturacion_provincia" value="{{ old('facturacion_provincia', $user->facturacion_provincia) }}" class="form-control" placeholder="Provincia">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input id="facturacion_municipio" type="text" name="facturacion_municipio" value="{{ old('facturacion_municipio', $user->facturacion_municipio) }}" class="form-control" placeholder="Municipio o ciudad">
                </div>

                <div class="form-group">
                    <label for="facturacion_info_adicional">Información adicional</label>
                    <input id="facturacion_info_adicional" type="text" name="facturacion_info_adicional" value="{{ old('facturacion_info_adicional', $user->facturacion_info_adicional) }}" class="form-control" placeholder="Indicaciones extra">
                </div>
            </div>
